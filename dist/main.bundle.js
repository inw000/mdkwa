...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataSercice) {
        this.dataSercice = dataSercice;
        this.title = 'app';
    }
